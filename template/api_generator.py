...
import {{
  ...
  {entity}PageParams,
  {entity}Params,
}} from './model/{lowerCamelEntity}Model';
...
enum Api {{
  ...
  Delete{entity} = '/{lowerCamelEntity}/delete{entity}/{{{lowerCamelEntity}Id}}',
}}
...
export const delete{entity} = ({lowerCamelEntity}Id: string) =>
  defHttp.delete({{ url: Api.Delete{entity}.replace('{{{lowerCamelEntity}Id}}', {lowerCamelEntity}Id) }});
'''
