<template>
  <PageWrapper title="票图结构模板">
    <CollapseContainer title="添加票图结构模板">
...
<script lang="ts">
  ...
  import { formSchema } from '/@/views/tmp/tmp-chart-split/tmpChartSplit.data';
        ...
        return new Promise((resolve) => {
          ...
          createSuccessModal({
            ...
            content: unref(isUpdate)
              ? t('sys.api.updateSuccessMsg', ['票图结构模板'])
              : t('sys.api.createSuccessMsg', ['票图结构模板']),
            closable: false,
